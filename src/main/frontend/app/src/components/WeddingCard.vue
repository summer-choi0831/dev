<template xmlns="http://www.w3.org/1999/html">
  <div class="container-fluid">
    ...
    <div v-if="mode === 'start'">
      ...
      <span class="mt-5 flex-center"> </span>
    </div>

    <div v-if="mode === 'question'">
      <span class="flex-center">
        <b-img
          v-bind="{ width: 554, height: 394 }"
          center
          :src="question[question_num].card"
          rounded
        ></b-img>
      </span>
      <span class="mt-5 flex-center">
...
export default {
  ...
  data() {
    return {
      ...
      question: [
        {
          img: "http://3.37.98.94/static/img/01.png",
          hint: "첫 인연이 시작된날은? 20ㅇㅇ.ㅇ.ㅇㅇ(숫자만)",
          answer: "16416",
          card: "http://3.37.98.94/static/img/card_02.png"
        },
        {
          img: "http://3.37.98.94/static/img/02.png",
          hint: "결혼식 날짜. 6월 ㅇㅇ일(숫자만)",
          answer: "13",
          card: "http://3.37.98.94/static/img/card_03.png"
        },
        {
          img: "http://3.37.98.94/static/img/03.png",
          hint: "결혼식 시간. ㅇㅇ:ㅇㅇ(숫자만)",
          answer: "1330",
          card: "http://3.37.98.94/static/img/card_04.png"
        },
        {
          img: "http://3.37.98.94/static/img/04.png",
          hint: "지하철역(ㅇㅇㅇ역)",
          answer: "보라매",
          card: "http://3.37.98.94/static/img/card_05.png"
        },
        {
          img: "http://3.37.98.94/static/img/05.png",
          hint: "결혼식 장소(대문자)",
          answer: "NOBLESSE",
          card: "http://3.37.98.94/static/img/card_06.png"
        }
      ]
    };
  },
